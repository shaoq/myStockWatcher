...
The system SHALL display reached indicators with color-coded status tags.
...
**Reason**: Changed from table-based display to card-based grouped display. The grouped display eliminates the need for pagination.

**Migration**: All reached stocks are now displayed in collapsible panels grouped by MA type. Users can expand/collapse groups to view details.
